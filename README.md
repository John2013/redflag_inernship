...
4. ### Циклы
    ...
    39. Дано действительное число x. Вычислить значение экспоненциальной функции 
        (то есть, показательной функции _ex_, где _e_ – математическая константа) в точке _x_ с заданной точностью _eps_ с помощью
        ряда Тейлора:
        
        ![](http://sdamzavas.net/imgbaza/baza4/1825395407115.files/image047.png)
        
        **Примечание 1:** показательными называются функции вида _ax_, где _a_ – некоторое действительное число, _x_ – независимая
