...
<ol>
	...
	<li>
		<p id="questions16">Дан массив с вопросами и правильными ответами. Реализуйте тест: выведите на экран все
			вопросы,
	...
	<li id="questions17">
		<p>Модифицируем предыдущую задачу: пусть теперь тест показывает варианты ответов и радиокнопочки. Пользователь
			должен выбрать один из вариантов.</p>
		<?
		$answers17 = [];
	...
	<li id="questions18">
		<p>Модифицируем предыдущую задачу: пусть теперь на один вопрос может быть несколько правильных ответов.
			Пользователь должен отметить один или несколько чекбоксов.</p>
		<?
		$questions = [];
		$questions[] = new MultipleAnswerQuestion(
			'Выберите один или несколько чисто функциональных языков программирования',
			[
				'Elm',
				'JavaScript',
				'Java',
		...
		$questions[] = new MultipleAnswerQuestion(
			'Выберите один или несколько скалярных типов данных PHP',
			[
				'Array',
				'int',
				'float',
		...
		?>
		<form action="#questions18" method="post">
			<?
